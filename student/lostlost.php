  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="panel panel-container" style="min-height:900px">
      ...
      <a href="lost.php">Back</a>
       ...
       <h1><a href="lostview.php"><em class="fa fa-cubes">Lost Item Reports, Click Here</a></h1></em>
    <h2><a href="lostfound.php"><em class="fa fa-archive">Found Item Reports, Maybe your Lost item is here? Click Here</a></h2></em>
