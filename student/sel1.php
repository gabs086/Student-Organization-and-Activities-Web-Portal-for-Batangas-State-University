...
<body>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar" style="bakcground-color:#000">
    ...
    <ul class="nav menu">
      ...
      <li><a href="lost.php"><em class="fa fa-cubes">&nbsp;</em>Lost & Found</a>
      ...
      <li  class="active"><a href="assessstud.php"><em class="fa fa-telegram">&nbsp;</em>Activity Assessment</a></li>
    
      <li><a href="survey.php"><em class="fa fa-sticky-note">&nbsp;</em>Survey Sheets</a></li>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
      <ol class="breadcrumb">
        ...
        <li class="active" >Activity Assessment</li>
      </ol>
    </div><!--/.row-->
...
<input type="submit" name="submit" value="Search">
  ...
  <table width="100%" border="1" style="border-collapse:collapse;font-size:15px;padding:5px;" class="tftable order-table table bluetext">
              ...
              <tr>
                <th style="color:#FFF"><b><center>Organization Name</th>
                <th style="color:#FFF"><b><center>Activity Name</th>
                <th style="color:#FFF"><b><center>Date of Activity</th>
                <th style="color:#FFF"><b><center>Requirements for joining</th>
                <th style="color:#FFF"><b><center>Description of the Activity</th>
              ...
              <tbody>
                <?php
include('../connect.php');
$result = mysql_query("SELECT * FROM assess ORDER BY ID DESC");
...
<h3>Want to Join an activity? Please register and fill up the form:</h3>

<form action="submitexec.php" method="POST" enctype="multipart/form-data" accept-charset="utf-8" style="margin-left:15px">
...
<div class="form-group">
        <label>Year:</label>
        <input type="text" name="year" required  class="form-control" size="40">
        </div>
<div class="form-group">
        <label>Department:</label>
        <input type="text" name="department" required  class="form-control" size="40">
        </div>
<div class="form-group">
        <label>Section:</label>
        <input type="text" name="section" required  class="form-control" size="40">
        </div>
        <input type="hidden" name="age" required  class="form-control" size="40">
        
        <div class="form-group">
        <label>Contact Number:</label>
        <input type="text" name="connum" required  class="form-control" size="40">
        </div>

         <div class="form-group">
        <label>Activity you want to join:</label>
