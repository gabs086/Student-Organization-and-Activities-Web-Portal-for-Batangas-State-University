...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
      ...
      <li class="active"><a href="idrep.php"><em class="fa fa-address-card-o">&nbsp;</em>ID Replacement</a></li>
...
<p>
  <b><h3>According to  Batangas State University Norms of Conduct 800 College Students AY 2014- 2015</h3></b><br>

  1. An official identification (ID) Card shall be issued to every student in the University.<br><br>
  2. If the ID card is torn, defaced or severely damaged, the student must surrender it to the SOA for replacement. <br>&nbsp;&nbsp;&nbsp;&nbsp;A temporary ID (or Gate Pass) shall be issued for a definite time limit.<br><br>
  3. In case the ID card is lost, the student should immediately report the matter to the SOA.<br>&nbsp;&nbsp;&nbsp;The first instance of reported loss shall not require an affidavit of loss. Any succeeding loss thereafter shall require one.<br><br>
  ...
  <a href="../student/BatStateU-FO-SOA-04_Request for New ID.docx" download="BatStateU-FO-SOA-04_Request for New ID"><center><img src="ID Form.png" alt="ID Replacement Format"></center></a>
