...
<a href="lost.php">< Back </a>
      ...
      <form action="lostviewfilter.php" method="POST">
Filter by Campus: 
...
<input type="submit" name="submit" value="Search">
      ...
      <div class="fakeimg" style="height:780px;">  
<table width="100%" border="1" style="border-collapse:collapse;font-size:15px;padding:5px;" class="tftable order-table table bluetext">
              ...
              <tr>
                ...
                <th style="color:#FFF"><b><center>SR Code</th>
                  <th style="color:#FFF"><b><center>Course</th>
...
while($row = mysql_fetch_array($result))
{
      ...
      echo '<td valign="top" style="color:#000">&nbsp;'.$row['course'].'</td>';
