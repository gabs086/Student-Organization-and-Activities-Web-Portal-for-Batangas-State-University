...
<body>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      ...
      <li class="active"><a href="lost.php"><em class="fa fa-cubes">&nbsp;</em>Lost & Found</a>
...
<a href="lost.php">< Back </a>
      <h2>Found Items, Maybe your Lost item is here? Check the list</h2>
            <form action="lostfoundfilter.php" method="POST">
Filter by Campus: 
...
include('../connect.php');
$campus = $_POST['campus'];
$result = mysql_query("SELECT * FROM found Where campus = '$campus' ORDER BY ID DESC");
