...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="assess.php"><em class="fa fa-cubes">&nbsp;</em> Assessment</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		include('../connect.php');
		$result = mysql_query("SELECT * FROM activities WHERE status = 'Pending' ORDER BY name ASC");
		while($row = mysql_fetch_array($result))
		{
			echo '<tr>';
			...
			echo '<td valign="top"><font color="#000">'.$row['time'].'</td>';
			echo '<td valign="top"><font color="#000">'.$row['venue'].'</td>';
			echo '<td valign="top"><font color="#000">'.$row['description'].'</td>';
			echo '<td valign="top"><font color="#000"><center><a href="approve.php?id='.$row["id"].'" style="color:#000">Approve</a>   | <a href="decline.php?id='.$row['id'].'"  style="color:#000">Decline</a></td>';
			echo '</tr>';
		}
