...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="check.php"><em class="fa fa-check">&nbsp;</em>Activity Request</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1>Check Requested Activities</h1></div>
		</div><!--/.row-->
		...
		<div class="panel panel-container" style="min-height:900px">
			...
			<tbody>
			  <?php
	  	include('../connect.php');
		$result = mysql_query("SELECT * FROM studformat WHERE status = '' AND campus = '$campus' ORDER BY ID DESC");
		while($row = mysql_fetch_array($result))
		{
			echo '<tr>';
			...
			echo ' <td style="color:#000"><a href="approve1.php?id='.$row["id"].'&name='.$row["orgname"].'&format='.$row["name"].'" style="color:#000">Approve</a> | <a href="decline3.php?id='.$row["id"].'&name='.$row["orgname"].'&format='.$row["name"].'" style="color:#000" rel="facebox">Decline</a></td>';
			echo '</tr>';
		}
?>
					</tbody>
