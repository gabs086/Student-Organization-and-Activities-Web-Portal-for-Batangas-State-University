...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li><a href="index.php"><em class="fa fa-dashboard">&nbsp;</em> Calendar</a></li>
			<li><a href=""><em class="fa fa-bullhorn">&nbsp;</em> News</a></li>
			<li><a href="news.php"><em class="fa fa-bar-chart">&nbsp;</em> Announcements</a></li>
			<li><a href="reports.php"><em class="fa fa-toggle-off">&nbsp;</em> Lost and Found</a></li>
			<li><a href="account.php"><em class="fa fa-clone">&nbsp;</em> Account Settings</a></li>
			<li class="active"><a href="guide.php"><em class="fa fa-toggle-off">&nbsp;</em> Guidelines</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">ID Replacement Guidelines</li>
			</ol>
		</div><!--/.row-->
...
<b>ID Replacement Guidelines</b>
<br><br>
<b>According to BatstateU Norms of Conduct for College Students AY2014-2015</b>
<br><br>
<p>1. An Official Identification (ID) shall be issued to every student in the University.</p>
<p>2. If the ID card was torn, defaced or severely damaged, the student must surrender it to the SOA for replacement. A Temporary ID (or Gate pass) shall be issued for a definite time limit.</p>
<p>3. In case the ID card is lost, the student should immediately report the matter to the SOA. The first instance of reported loss shall not inquire an affidavit of loss. Any succeeding loss thereafter shall require one.</p>
<p>4.Any student who report loss of ID more than three (3) times in a semester may be investigated by the SOA or OSD for possible violation of item.
<p>5. Procedures for ID replacement in cases of itme #2 and #3 above:</p>
<p>5.1. Apply for a new ID in the SOA and secure a Temporary ID (or Gate Pass).</p>
<p>5.2 Proceed to the Cashiers Office and pay for the corresponding fee for ID replacement. NOTE: Any BatStateU personnel who lost a student iD in his/her custody shall be liable for the payment of its replacement.</p>
<p>5.3. Proceed to the Encoding Office for picture taking.</p>
<p>6. Any student wearing a Temporary ID (or Gate Pass) may be asked anytime by any University authority to show his/her Registration Form</p>
	
<br><br>
<b>Request For New I.D. Form</b>
<br>
<br>
	Downloadable form: <br>	<a href=""><img src="../images/ID Form.png" width="350px"></a>
