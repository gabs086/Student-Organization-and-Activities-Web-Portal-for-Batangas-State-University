...
<li><a href="index.php"><em class="fa fa-calendar">&nbsp;</em> Calendar</a></li>				
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		include('../connect.php');
		$id = $_GET['id'];
		$result = mysql_query("SELECT * FROM orga WHERE id = '$id'");
		...
		<div class="panel panel-container" style="min-height:500px">
			<!-- start content -->
			<br>
			<form role="form" style="margin-left:15px" action="update12.php" method="POST">
...
<option>GE</option>
								...
								<div class="form-group">
									...
									<input type="text"  class="form-control" name="orgpres" value="<?php echo $orgpres ?>">
								</div>

								<div class="form-group">
									<label>Organization Adviser:</label>
									<input type="text"  class="form-control" name="orgad" value="<?php echo $orgad ?>">
								</div>
								...
								<div class="form-group">
									...
									<input type="text"  class="form-control" name="officers" value="<?php echo $officer ?>">
								</div>
							...
							<input type="submit" value="Update Student Organization" name="submit" class="myButton">
