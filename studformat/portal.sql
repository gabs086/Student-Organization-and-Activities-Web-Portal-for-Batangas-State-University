...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2018 at 02:53 AM
...
(1, NULL, 'AGSPBA - Association of Graduate Students of Public and Business Administration', '"Fieldtrip activity for SDC Main 1 Campus" request has been approved by SOA Head', 'read');
...
CREATE TABLE IF NOT EXISTS `recordassess` (
  `id` int(11) NOT NULL,
  `campus` varchar(255) DEFAULT NULL,
...
INSERT INTO `reports` (`id`, `name`, `description`, `file`, `orgname`, `username`, `status`, `campus`) VALUES
(1, 'Activity Reports', 'Report of the Activity Implemented			', 'Student Organization Accomplishment Report Format.docx', 'AGSPBA - Association of Graduate Students of Public and Business Administration', 'agspbamain1', 'Approved', 'BatStateU Pablo Borbon Main I');
...
CREATE TABLE IF NOT EXISTS `studform` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `format` varchar(255) DEFAULT NULL
...
(2, 'Fieldtrip activity for SDC Main 1 Campus', 'Checklist of Requirements for CMO  63 (Local Off campus Activity) (1).docx', 'AGSPBA - Association of Graduate Students of Public and Business Administration', 'Approved1', 'BatStateU Pablo Borbon Main I'),
(3, 'Fieldtrip activity for SDC Main 1 Campus', 'abstract (1).docx', 'AGSPBA - Association of Graduate Students of Public and Business Administration', '', 'BatStateU Pablo Borbon Main I');
