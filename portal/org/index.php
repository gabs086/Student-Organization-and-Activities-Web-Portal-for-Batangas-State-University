...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="index.php"><em class="fa fa-dashboard">&nbsp;</em> Calendar</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container" style="min-height:900px">
			<!-- start content -->
			<input type="button" value="Add Event" onclick="window.location='add.php'" class="myButton">
			
<script src="jscript/jquery.min.js"></script>
			<div id="calendar_div" class="calendar">
