...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="reports.php"><em class="fa fa-toggle-off">&nbsp;</em> Reports</a></li>
...
<table width="100%" border="1" style="border-collapse:collapse;font-size:15px;padding:5px;" class="tftable order-table table bluetext">
			...
			<?php
include('../connect.php');
$result = mysql_query("SELECT * FROM announcement  ORDER BY date ASC");
while($row = mysql_fetch_array($result))
{
			echo '<tr>';
			...
			echo '<td width="35%" style="color:#000"><center><a href="viewevent.php?id='.$row["id"].'" style="color:#000">View Event</a></td>';
			echo '</tr>';
}
?>
