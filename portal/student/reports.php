...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="reports.php"><em class="fa fa-toggle-off">&nbsp;</em> Lost and Found</a></li>
			<li><a href="account.php"><em class="fa fa-clone">&nbsp;</em> Account Settings</a></li>
			<li><a href="guide.php"><em class="fa fa-toggle-off">&nbsp;</em> Guidelines</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Lost and Found</li>
			</ol>
		</div><!--/.row-->
