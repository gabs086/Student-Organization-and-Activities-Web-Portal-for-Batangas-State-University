...
.tftable {
	...
	font-size:12px;color:#333333;width:98%;border-width: 1px;border-color: #ebab3a;border-collapse: collapse;}
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="lost.php"><em class="fa fa-toggle-off">&nbsp;</em> Lost and Found</a></li>
...
while($row = mysql_fetch_array($result))
{
			...
			echo '<td valign="top" style="color:#000">&nbsp; Set as Claimed | Item Found</td>';
			echo '</tr>';
}
?>
