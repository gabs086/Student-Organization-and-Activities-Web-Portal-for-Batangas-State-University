...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		include('../connect.php');
		$result = mysql_query("SELECT * FROM org ORDER BY name ASC");
		while($row = mysql_fetch_array($result))
		{
			echo '<tr>';
			echo '<td valign="top"><font color="#000">'.$row['name'].'</td>';
			echo '<td valign="top"><font color="#000">'.$row['head'].'</td>';
			echo '<td valign="top"><font color="#000">'.$row['description'].'</td>';
			echo '<td valign="top"><font color="#000"><center>View Reports   | <a href="delete.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to delete this student organization?\')" style="color:#000">Delete</a></td>';
			echo '</tr>';
		}
