...
?>		
			<li class="active"><a href="notification.php"><em class="	fa fa-user">&nbsp;</em> Notifications [<?php echo $count ?>]</a></li>
	...
	<?php
	include('../connect.php');
	$result2 = mysql_query("SELECT * FROM notification WHERE username='$name' ORDER BY ID DESC");
while($row2 = mysql_fetch_array($result2))
	{
		echo '<li>'.$row2["notification"].'</li>';
		
	}
	mysql_query("UPDATE notification SET status='read' WHERE username='$name'");
