...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li  class="active"><a href="upload.php"><em class="fa fa-upload">&nbsp;</em>Activity Request</a>
...
?>		
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Activity Request Approval</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="panel panel-container" style="min-height:900px">
			...
			<div class="row">
			<div class="col-lg-12">
				<h1>Activity Request Approval</h1></div>
		</div><!--/.row-->
 ...
 <form action="formatexec.php" method="POST" enctype="multipart/form-data" accept-charset="utf-8" style="margin-left:15px">
	...
	<div class="form-group">
	<label>Request Activity Name:</label>
	<input type="text" required name="name" class="form-control">
	<input type="hidden" name="org" class="form-control" value="<?php echo $name ?>">
	</div>						
	<div class="form-group">
	<label>Activity Request File:</label>
	<input type="file" required name="file_array" class="form-control">
	</div>
						<div class="form-group">
									<label>Campus:</label>
...
<option>BatStateU Lobo</option>
	...
	(Please Double Check what you input before clicking Upload Activity Request**)<br><br>
<input type="submit" value="Upload Activity Request" name="submit" class="myButton">
