...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li  class="active"><a href="format.php"><em class="fa fa-file-text-o">&nbsp;</em>Formats</a>
...
?>		
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		{
		echo '<tr>';
      echo '<td><div class="fakeimg" style="margin-left:15px"> <a href="../format/'.$row["format"].'" download style="color:#000"><i class="fa fa-folder"></i>&nbsp;'.$row["format"].' </td></div>';
