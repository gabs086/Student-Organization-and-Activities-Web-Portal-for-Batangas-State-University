...
<option>BatStateU San Juan</option>
   ...
   <div class="form-group">
	...
	<textarea style="height:150px" class="form-control" name="description">
								...
								(Please Double Check what you input before clicking Record**)<br><br>
								<input type="submit" name="Record" class="myButton" >
								</div>
							</form>	
...
include('../connect.php');
$campus = $_POST['campus'];
$result = mysql_query("SELECT * FROM assess  WHERE org = '$name' AND campus = '$campus' ORDER BY acassess DESC");
while($row = mysql_fetch_array($result))
{
			echo '<tr>';
